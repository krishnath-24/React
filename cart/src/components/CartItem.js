    ...
    return (
            <div className="cart-item">
                ...
                <div className="left-block">
                    <img alt="product-img" style={styles.image} src={image}/>
                </div>
                <div className="right-block">
                    ...
                    <div className="cart-item-actions">
                        ...
                        <img onClick = {() => props.onDelete(product.id, product.quantity)} alt="delete" className="action-icons" src="https://image.flaticon.com/icons/svg/1214/1214428.svg"></img>
                    </div>
                </div>
            </div>
        )
